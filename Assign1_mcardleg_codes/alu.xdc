...
#set_property PACKAGE_PIN V7 [get_ports sel]							
	#set_property IOSTANDARD LVCMOS33 [get_ports sel]

#set_property PACKAGE_PIN U2 [get_ports {digit_activate[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {digit_activate[0]}]
#set_property PACKAGE_PIN U4 [get_ports {digit_activate[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {digit_activate[1]}]
#set_property PACKAGE_PIN V4 [get_ports {digit_activate[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {digit_activate[2]}]
#set_property PACKAGE_PIN W4 [get_ports {digit_activate[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {digit_activate[3]}]
